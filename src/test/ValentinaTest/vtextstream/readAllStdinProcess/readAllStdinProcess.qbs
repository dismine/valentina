...
CppApplication {
  ...
  Properties {
      ...
      cpp.rpaths: FileInfo.joinPaths(cpp.rpathOrigin, "..", buildconfig.installLibraryPath)
  }
  ...
  Export {
      ...
      cpp.defines: {
          var defines = [];
          defines.push('READ_ALL_STDIN_PROCESS_BUILDDIR="' + FileInfo.joinPaths(exportingProduct.buildDirectory, exportingProduct.targetName) +'"');
          return defines;
      }
  }
}

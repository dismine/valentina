...
#include "../vmisc/codecs/qstringiterator_p.h"

#include <QTest>

//---------------------------------------------------------------------------------------------------------------------
TST_QStringIterator::TST_QStringIterator(QObject *parent)
  : QObject{parent}
{
}
...
void TST_QStringIterator::sweep_data()
{
    ...
    QTest::newRow("sweep_05") << QString::fromUtf8(
        "\xe6\xb0\xb4\xe6\xb0\xb5\xe6\xb0\xb6\xe6\xb0\xb7\xe6\xb0\xb8\xe6\xb0\xb9", 18)
                              << true << 6;
    QTest::newRow("sweep_06") << QString::fromUtf8("\xf0\x9f\x98\x81\xf0\x9f\x98\x82\x61\x62\x63\xf0\x9f\x98\x83\xc4"
                                                   "\x91\xc3\xa8\xef\xac\x80\xf0\x9f\x98\x84\xf0\x9f\x98\x85",
                                                   30)
                              << true << 11;
    QTest::newRow("sweep_07") << QString::fromUtf8(
        "\xf0\x9f\x82\xaa\xf0\x9f\x82\xab\xf0\x9f\x82\xad\xf0\x9f\x82\xae\xf0\x9f\x82\xa1\x20\x52\x4f\x59\x41\x4c\x20"
        "\x46\x4c\x55\x53\x48\x20\x4f\x46\x20\x53\x50\x41\x44\x45\x53",
        42) << true << 27;
    QTest::newRow("sweep_08") << QString::fromUtf8("abc\0def", 7) << true << 7;
    QTest::newRow("sweep_09") << QString::fromUtf8(
        "\xc3\xa0\xce\xb2\xc3\xa7\xf0\x9f\x80\xb9\xf0\x9f\x80\xb8\x00\xf0\x9f\x80\xb1\x00\xf0\x9f\x80\xb3\xf0\x9f\x81"
        "\x85\xe1\xb8\x8a\xc4\x99\xc6\x92",
        35) << true << 13;
...
#define QSTRING_FROM_QCHARARRAY(x) (QString((x), sizeof(x) / sizeof((x)[0])))
    ...
    static const QChar invalid_04[] = {QLatin1Char('i'),
                                       QLatin1Char('n'),
                                       QLatin1Char('v'),
                                       QLatin1Char('a'),
                                       QLatin1Char('l'),
    ...
    static const QChar invalid_05[] = {QLatin1Char('i'),
                                       QLatin1Char('n'),
                                       QLatin1Char('v'),
                                       QLatin1Char('a'),
                                       QLatin1Char('l'),
    ...
    static const QChar invalid_06[] = {QLatin1Char('i'),
                                       QLatin1Char('n'),
                                       QLatin1Char('v'),
                                       QLatin1Char('a'),
                                       QLatin1Char('l'),
    ...
    static const QChar invalid_07[] = {QLatin1Char('i'),
                                       QLatin1Char('n'),
                                       QLatin1Char('v'),
                                       QLatin1Char('a'),
                                       QLatin1Char('l'),
    ...
    static const QChar invalid_08[] = {QChar(0xd800),
                                       QLatin1Char('i'),
                                       QLatin1Char('n'),
                                       QLatin1Char('v'),
                                       QLatin1Char('a'),
    ...
    static const QChar invalid_09[] = {QChar(0xdc00),
                                       QLatin1Char('i'),
                                       QLatin1Char('n'),
                                       QLatin1Char('v'),
                                       QLatin1Char('a'),
    ...
    static const QChar invalid_10[] = {QChar(0xd800),
                                       QChar(0xd800),
                                       QLatin1Char('i'),
                                       QLatin1Char('n'),
                                       QLatin1Char('v'),
    ...
    static const QChar invalid_11[] = {QChar(0xdc00),
                                       QChar(0xd800),
                                       QLatin1Char('i'),
                                       QLatin1Char('n'),
                                       QLatin1Char('v'),
    ...
    static const QChar invalid_12[] = {QChar(0xdc00),
                                       QChar(0xdc00),
                                       QLatin1Char('i'),
                                       QLatin1Char('n'),
                                       QLatin1Char('v'),
    ...
    static const QChar invalid_13[] = {QLatin1Char('i'),
                                       QLatin1Char('n'),
                                       QLatin1Char('v'),
                                       QChar(0xd800),
                                       QChar(0xdf00), // U+10300 OLD ITALIC LETTER A
                                       QLatin1Char('a'),
                                       QLatin1Char('l'),
                                       QLatin1Char('i'),
                                       QLatin1Char('d'),
    ...
    static const QChar invalid_14[] = {QLatin1Char('i'),
                                       QLatin1Char('n'),
                                       QLatin1Char('v'),
                                       QChar(0xd800),
                                       QChar(0xdf00), // U+10300 OLD ITALIC LETTER A
    ...
    static const QChar invalid_15[] = {QLatin1Char('i'),
                                       QLatin1Char('n'),
                                       QLatin1Char('v'),
                                       QChar(0xd800),
                                       QChar(0xdf00), // U+10300 OLD ITALIC LETTER A
    ...
    static const QChar invalid_16[] = {QLatin1Char('i'),
                                       QLatin1Char('n'),
                                       QLatin1Char('v'),
                                       QChar(0xd800),
                                       QChar(0xdf00), // U+10300 OLD ITALIC LETTER A
    ...
    static const QChar invalid_17[] = {QChar(0xd800),
                                       QLatin1Char('i'),
                                       QLatin1Char('n'),
                                       QLatin1Char('v'),
                                       QChar(0xd800),
    ...
    static const QChar invalid_18[] = {QChar(0xdc00),
                                       QLatin1Char('i'),
                                       QLatin1Char('n'),
                                       QLatin1Char('v'),
                                       QChar(0xd800),
...
void TST_QStringIterator::position()
{
    static const QChar stringData[] = {
        ...
        // codeunit count: 12
        QChar(0xD834),
        QChar(0xDD1E), // U+1D11E MUSICAL SYMBOL G CLEF
        // codeunit count: 14
        QChar(0xD834),
        QChar(0xDD21), // U+1D121 MUSICAL SYMBOL C CLEF
        // codeunit count: 16
        QLatin1Char('j'),
        // codeunit count: 17
        ...
        // codeunit count: 21
        QChar(0xD800),
        QChar(0xD800), // two high surrogates
        // codeunit count: 23
        QLatin1Char('m'),
        // codeunit count: 24
        QChar(0xDC00),
        QChar(0xDC00), // two low surrogates
        // codeunit count: 26
        QLatin1Char('n'),
        // codeunit count: 27
        QChar(0xD800),
        QChar(0xD800),
        QChar(0xDC00), // stray high surrogate followed by valid pair
        // codeunit count: 30
        QLatin1Char('o'),
        // codeunit count: 31
        QChar(0xDC00),
        QChar(0xD800),
        QChar(0xDC00), // stray low surrogate followed by valid pair
        // codeunit count: 34
        QLatin1Char('p')
        // codeunit count: 35
    };
...
#define QCHAR_UNICODE_VALUE(x) (static_cast<uint>(QChar(x).unicode()))

...
public:
   ...
   */
    [[nodiscard]] constexpr bool is_directed() const { return GRAPH_TYPE_V == graph_type::DIRECTED; }
   ...
   */
    [[nodiscard]] constexpr bool is_undirected() const { return GRAPH_TYPE_V == graph_type::UNDIRECTED; }
   ...
   * provided vertex.
   */
    [[nodiscard]] const vertex_id_to_vertex_t &get_vertices() const noexcept { return vertices_; }
   ...
   */
    [[nodiscard]] const edge_id_to_edge_t &get_edges() const noexcept { return edges_; }

...
vertex_id_t do_find_set(vertex_id_t vertex, std::unordered_map<vertex_id_t, vertex_id_t> &parent)
{
...
std::vector<edge_id_t> kruskal_minimum_spanning_tree(const graph<V, E, graph_type::UNDIRECTED> &graph)
{
    ...
    {
        if (detail::do_find_set(edge.vertex_a, parent) != detail::do_find_set(edge.vertex_b, parent))
        {

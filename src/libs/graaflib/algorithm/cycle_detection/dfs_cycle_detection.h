...
[[nodiscard]] bool dfs_cycle_detection(const graph<V, E, graph_type::DIRECTED> &graph);
 ...
 */
template<typename V, typename E>
[[nodiscard]] bool dfs_cycle_detection(const graph<V, E, graph_type::UNDIRECTED> &graph);

...
requires derived_from_weighted_edge<WEIGHTED_EDGE_T> [[nodiscard]] auto get_weight(const WEIGHTED_EDGE_T &edge);

template<typename EDGE_T>
requires std::is_arithmetic_v<EDGE_T> [[nodiscard]] EDGE_T get_weight(const EDGE_T &edge);

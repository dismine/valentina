...
#error \
    "VTextCodec support is required but has not been enabled. Please disable the withTextCodec in your build configuration."
#endif

class QByteArray;

// Replacement for QTextCodec when support of text codecs disabled.
class VTextCodec
{
public:

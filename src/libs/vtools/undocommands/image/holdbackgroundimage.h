 ...
 **
 *************************************************************************/
#ifndef HOLDBACKGROUNDIMAGE_H
#define HOLDBACKGROUNDIMAGE_H
...
private:
    ...
    Q_DISABLE_COPY_MOVE(HoldBackgroundImage)
    QUuid m_id;
    bool m_hold;
    bool m_oldHold{false};
};

#endif // HOLDBACKGROUNDIMAGE_H

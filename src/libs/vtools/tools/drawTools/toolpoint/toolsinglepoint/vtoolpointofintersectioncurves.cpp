...
{
//---------------------------------------------------------------------------------------------------------------------
void InitUniqueSegmentConnections(VMainGraphicsScene *scene, VToolPointOfIntersectionCurves *tool, GOType type)
{
    ...
    switch (type)
    {
        case GOType::Arc:
            QObject::connect(scene,
                             ...
                             tool,
                             &VToolPointOfIntersectionCurves::SetArcSegmentLabelVisible,
                             Qt::UniqueConnection);
            QObject::connect(scene,
                             &VMainGraphicsScene::EnableArcItemHover,
                             tool,
                             &VToolPointOfIntersectionCurves::AllowArcSegmentHover,
                             Qt::UniqueConnection);
            break;
        case GOType::EllipticalArc:
            QObject::connect(scene,
                             ...
                             tool,
                             &VToolPointOfIntersectionCurves::SetElArcSegmentLabelVisible,
                             Qt::UniqueConnection);
            QObject::connect(scene,
                             &VMainGraphicsScene::EnableElArcItemHover,
                             tool,
                             &VToolPointOfIntersectionCurves::AllowElArcSegmentHover,
                             Qt::UniqueConnection);
            break;
        case GOType::Spline:
        case GOType::CubicBezier:
            QObject::connect(scene,
                             ...
                             tool,
                             &VToolPointOfIntersectionCurves::SetSplineSegmentLabelVisible,
                             Qt::UniqueConnection);
            QObject::connect(scene,
                             &VMainGraphicsScene::EnableSplineItemHover,
                             tool,
                             &VToolPointOfIntersectionCurves::AllowSplineSegmentHover,
                             Qt::UniqueConnection);
            break;
        ...
        case GOType::CubicBezierPath:
            QObject::connect(scene,
                             ...
                             tool,
                             &VToolPointOfIntersectionCurves::SetSplinePathSegmentLabelVisible,
                             Qt::UniqueConnection);
            QObject::connect(scene,
                             &VMainGraphicsScene::EnableSplinePathItemHover,
                             tool,
                             &VToolPointOfIntersectionCurves::AllowSplinePathSegmentHover,
                             Qt::UniqueConnection);
            break;
        case GOType::Point:
